...
<div class="container text-center d-md-none d-sm-block">
	<img src="{{site.baseurl}}/assets/images/sponsors/ghc_snap_logo.png" class="" style="max-width: 30%; width: 30%;" alt="Snap Inc Logo">
</div>

<img src="{{site.baseurl}}/assets/images/sponsors/ghc_snap_logo.png" class="float-right d-xs-none d-sm-none d-md-block d-none pl-3 pb-3" style="max-width: 25%; width: 25%;" alt="Snap Inc Logo">
